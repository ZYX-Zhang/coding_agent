...
__all__ = [
    ...
    "SearchCodeTool", "RunCommandTool", "FinishTool", "FINISH_MARKER", "RunTestsTool",
    "build_registry", "_safe_path",
]


def build_registry(workspace: str, llm=None, ask=None,
                   should_cancel=None, on_event=None) -> ToolRegistry:
